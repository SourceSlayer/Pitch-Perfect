...
if __name__=="__main__":
    ...
    #parser.add_argument("--config-format", action="store", help="Specifies the format of the configuration file, out of \"CFG\", \"JSON\" or \"PY\" (be careful with this).", default="CFG")
